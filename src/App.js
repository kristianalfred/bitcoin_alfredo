...
import {TabView,TabPanel} from 'primereact/components/datatavle/DataTable';
...
class App extends Component {
  ...
  componentDidMount() {
    axios.get('https://blockchain.info/ticker').then((amnilData)=>{
      ...
      return (
        <div className="App">
          <header className="App-header">
            <img src="https://officialpsds.com/imageview/ry/91/ry916v_large.png?1521316606" className="App-logo" alt="logo" />
            <h1 className="App-title">Bitcoint - Blockchain</h1>
            <h5>Kristian</h5>
          </header>
